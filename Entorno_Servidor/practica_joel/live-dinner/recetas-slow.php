			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<p>En este apartado veremos recetas de cocción lenta</p>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<?php
				include('controllers/control-recetaslo.php');
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="blog-box-inner">
						...
						<img class="img-fluid" src="images/blog-img-01.jpg" alt="">
							<?php
							//echo '<img class="img-fluid" src="data:image/jpeg;base64,' . base64_encode( $receta['imagen'] ) . '" style="height:470px; width: 570px;  />'
							?>
						</div>
