...
$query = "SELECT id, imagen, titulo, elaboracion, tipo_receta FROM recetas WHERE tipo_receta ='Receta Freidora de Aire'";
...
$query = "
	SELECT SQL_CALC_FOUND_ROWS * FROM recetas WHERE tipo_receta ='Receta Freidora de Aire'
