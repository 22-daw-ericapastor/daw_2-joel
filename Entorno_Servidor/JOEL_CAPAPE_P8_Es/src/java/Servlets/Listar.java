...
public class Listar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            //Se instancia la clase para trabajar con la BD
            ...
            try {
                ...
                ArrayList list = b.listarUsuario();

                //Se crea la variable de sesion
                HttpSession sesion = request.getSession(true);
                //Se añanden la lista de usuarios a la variable de sesion
            ...
            response.sendRedirect(response.encodeRedirectURL("listar.jsp"));
        }
    }
