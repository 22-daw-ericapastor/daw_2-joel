 ...
 * @author user
 */
@WebServlet(name = "Modificar2", urlPatterns = {"/Modificar2"})
public class Modificar2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean correcto = act.actualizarContrasena(nombreUsuario, contrasena, contraNueva, contra2);
            
            if(correcto){
                System.out.println("HAS ACTUALIZADO LA CONTRASEÑA");
