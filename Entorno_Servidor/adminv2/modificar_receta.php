            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="p-5">
                        ...
                        ?>
                        <form class="user" method="POST" action="controllers/control_modificar_receta.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                    ...
                                    <table class="table table-bordered table-hover" id="tablaprueba">   
                                        <tr>
                                            ...
                                            <td><input type="number" name="cantidad[]" class="form-control quantity" value="<?php echo $_SESSION['nombre_ingredientes'][$i]['cantidad']; ?>" required></td>
                    ...
                    <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php
                            require('controllers/control_eliminar_receta.php');
                            ...
                            <!--FOR CON LOS DIFERENTES DATOS QUE HAY-->
                                ...
                                <form method="POST" action="controllers/control_buscar_receta_modificar.php">
