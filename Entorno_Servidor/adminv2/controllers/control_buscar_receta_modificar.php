...
if(isset($_POST['idreceta'])){
	...
	$sql = "SELECT imagen.id, imagen.titulo, imagen.tipo_receta, imagen.elaboracion, imagen.imagen
	from imagen
	 where imagen.id='".$id_receta."'";
	 ...
	 $resultados = $result->fetch_array();
	  ...
	  $consulta_ingredientes = "SELECT ingredientes.id_ingrediente, ingredientes.nombre_ingrediente, ingredientes.cantidad from imagen join ingredientes on imagen.id=ingredientes.id_receta where imagen.id=".$id_receta."";
