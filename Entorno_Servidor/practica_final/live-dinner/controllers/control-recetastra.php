...
$query = "SELECT id, imagen, titulo, elaboracion, tipo_receta FROM recetas WHERE tipo_receta ='Receta Tradicional'";
...
$query = "
	SELECT SQL_CALC_FOUND_ROWS * FROM recetas WHERE tipo_receta ='Receta Tradicional'
