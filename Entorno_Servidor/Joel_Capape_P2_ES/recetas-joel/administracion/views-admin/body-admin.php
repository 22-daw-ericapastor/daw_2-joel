...
<body id="page-top">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="crear_administrador.php">Crear&nbsp;Administrador</a>
                        <a class="collapse-item" href="eli_usuario_admin.php">Eliminar&nbsp;Usuario</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseComentarios" class="collapse" aria-labelledby="headingComentarios"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="eliminar_mensajes.php">Eliminar&nbsp;Mensajes</a>
            ...
            <div class="text-center d-none d-md-inline">
                <form action="controllers-admin/cerrar_sesion.php" method="POST">
