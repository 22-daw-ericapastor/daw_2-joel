            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="controllers-admin/control_receta.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <script type="text/javascript">
                                      ...
                                      '<td><input type="text" name="cantidad[]" class="form-control quantity" autocomplete="off" required></td>';
                                    }
                        ...
                        if(isset($_SESSION['existe_receta'])){
                            echo'<script>alert("Ya existe la receta")</script>';
                            unset($_SESSION['existe_receta']);
                        }
