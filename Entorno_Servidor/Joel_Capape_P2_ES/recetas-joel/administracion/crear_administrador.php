            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="controllers-admin/crear_admin.php">
...
if(isset($_SESSION['existe_ya'])){
    echo'<script>alert("Este admin ya existe")</script>';
    unset($_SESSION['existe_ya']);
}
